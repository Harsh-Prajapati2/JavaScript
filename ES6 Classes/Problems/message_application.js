...
4- The Message has the following static methods:-
    a- recordMessage - To keep track of total number of messages sent. It should be able to increment the totalMessage every time it is 
        called. This method should be called every time a new message is sent using the `Message` class.
    b- changeStatus - It should be able to change the static property status to true or false depending on its value and 
        console a message representing the status as  " the status has been changed to online/offline" depending on the value of status.
5- The Class should have the following public methods:-
    ...
    d- displayDetail - It should be able to display the sender, Receiver, message content, 
        Status, and total message in the form of key Value pair as shown in the expected output.
...
// function main() {
    //Create your Message Class here with all the properties and methods
     class Message{
        ...
        // static variable
        static totalMessage = 0;  // count total message
        static status = false; // show status of the User

        // static methods
        // a - recordMessage
        static recordMessage(){
            Message.totalMessage = Message.totalMessage + 1;
        }
        // b - changeStatus
        static changeStatus(){
