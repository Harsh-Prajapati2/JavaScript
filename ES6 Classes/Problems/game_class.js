/*
Suppose you are building a game that involves different types of characters, such as warriors, mages, and archers. 
Each character has a set of common properties, such as health, strength, and agility, as well as unique properties, such as weapon type, 
spell type, and arrow type. You want to use constructor functions to create these characters and their properties.
...
function main(){
  ...
  //Create Warrior ,Mage, Enemy and Archer constructor function inheriting Character
    ...
    Mage.prototype = Object.create(Mage.prototype);
    // Archer
    function Archer(health,strength,agility,arrowTpye){
        Character.call(this,health,strength,agility);
        this.arrowTpye = arrowTpye;        
    }
    Archer.prototype = Object.create(Character.prototype);
  //Create constructor function for Hero inheriting Warrior and Mage
    // Hero
    function Hero(health,strength,agility,weaponTpye,spellType,specialAbility){
        Warrior.call(this,health,strength,agility,weaponTpye);
