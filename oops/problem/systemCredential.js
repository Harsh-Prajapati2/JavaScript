...
// The method should check if the provided username and password match the systemCredentials.
//  If they match, it should log "Login successful!" to the console. 
// Otherwise, it should log "Login failed!".

// Lastly, modify the login method by using the bind method to create a reusable function named
//  loginFunction that is bound to the systemCredentials object.
