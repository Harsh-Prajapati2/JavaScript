/** Problem statement
You are given three arrays: one containing user IDs, one with user names, and 
another with the corresponding user images. Your task is to combine these three arrays 
into a single array of objects, where each object represents a user with their ID, name, and image.

Objectives
1. Function Creation: Write a function named createUserObjects that takes 
   three arrays as parameters: ids, names, and images.
2. Map Function Usage: Inside the function, use the map method to create an array of user objects. 
...
3. Mapping Logic: Ensure that the mapping aligns the first elements of all arrays into the first object,
   the second elements into the second object, and so on. 
