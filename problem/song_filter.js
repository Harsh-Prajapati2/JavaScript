...
Objectives
1. You need to write a function that takes in an array of songs and 
returns a new array that contains only songs of a specific genre, and 
then you need to retrieve all the songs whose duration is longer than the specified duration.
...
- Then, it filters those results to include only the songs that are longer than or equal
...
function filterSongs(songs, filters) {
  ...
  return songs.filter(song => 
    song.genre === genre && song.duration >= duration
  );
}
